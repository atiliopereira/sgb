...
class LiquidacionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'factura': forms.TextInput(attrs={'class': 'form-control formatted-decimal', 'style': 'text-align:right', 'placeholder': '0,00'}),
            'flete': forms.TextInput(attrs={'class': 'form-control formatted-decimal', 'style': 'text-align:right', 'placeholder': '0,00'}),
